...
export default function ProyectoSeguimineto() {
  ...
  const consultarRadicaciones = async() =>{
    setLoading(true);
    axios.get(`${EXTERNAL_API_PATHS.radiFiltro}${idRadicacion}`)
     .then((response)=>{
         setRadicaciones(response.data[0])
         setLoading(false)
     })
     .catch((e)=>{
         console.log(e);
                ...
                <GridItem xs={12} sm={12} md={12}>
                  <Card>
                    <Heading
                            ...
                            category={<h3>{radicaciones.num_radicacion}</h3>}
                    />
                    <CardBody>
                                        ...
                                        <div className="" id="headingTwoTwo">
                                            <h2 className="mb-0">
                                                <Button
                                                    ...
                                                    style={{backgroundColor: primaryColor[0], color:'#FFF'}}
                                                    ...
                                                    <GridContainer justify="space-between">
                                                        <GridItem xs={12} sm={12} md={12}>
                                                            <Table
                                                                ...
                                                                tableData={                                        
                                                                    radicaciones.seguimiento.map((segui,index)=>[                      
                                                                        <p className="text-center">
                                                                            <b>{segui.fecha}</b>
                                                                        </p>,
                                                                        <p className="text-center">
