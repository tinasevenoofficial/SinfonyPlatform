...
export default function CopiaRegisCivilMatriPropio() {
    ...
    const sendData = () => {
        if ((numeroDocu && numeroFolio && comentarios) !== '' && (cedulaSolicitante)) {
            ...
            formData.append('tipo_documento', 'registro_propio');
    ...
    return (
        <div>
            ...
            <Dialog fullWidth="true" maxWidth="md" open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title" style={{ paddingTop: '25px' }}>Copia registro civil de matrimonio (propio)</DialogTitle>
                <DialogContent>
                    <form >
                        <GridContainer >
