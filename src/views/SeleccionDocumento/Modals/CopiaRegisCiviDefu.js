...
export default function CopiaRegisCiviDefu() {
    ...
    const [fechaDefu, setFechadefu] = useState('');
    ...
    const sendData = () => {
        if ((numeroDocu && numeroFolio && nombre && fechaDefu) !== '' && (cedulaSolicitante)) {
            ...
            formData.append('tipo_documento', 'registro_defuncion');
            formData.append('identificacion', numeroDocu);
            formData.append('nombre_registro', nombre);
            formData.append('fecha_defuncion', fechaDefu);
    ...
    return (
        <div>
            ...
            <Dialog fullWidth="true" maxWidth="md" open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title" style={{ paddingTop: '25px' }}>Copia registro civil de defunción</DialogTitle>
                <DialogContent>
                    <form >
                        <GridContainer >
                        ...
                        <GridContainer >
                            <GridItem className={classes.color} md={6}>
                                <CustomInput
                                    labelText="Nombre en el registro"
                                    labelProps={{
                                        shrink: true,
                                        classes: {
                                            root: classes.root,
                            ...
                            <GridItem className={classes.color} md={6}>
                                <CustomInput
                                    ...
                                    inputProps={{
                                        type: "date",
                                        onChange: (e) => setFechadefu(e.target.value),
                                        value: fechaDefu,
                                    }}
                                />
                            </GridItem>
