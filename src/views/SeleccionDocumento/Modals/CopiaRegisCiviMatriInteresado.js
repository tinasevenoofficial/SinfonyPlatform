...
export default function CopiaRegisCivilMatriInteresado() {
    ...
    const sendData = () => {
        if ((numeroDocu && numeroFolio) !== '' && (cedulaSolicitante && cartaAuto)) {
            ...
            formData.append('tipo_documento', 'registroMatri_interesado');
            ...
            formData.append('documento_2', cartaAuto, 'carta_autorizacion_registrados');
    ...
    return (
        <div>
            ...
            <Dialog fullWidth="true" maxWidth="md" open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title" style={{ paddingTop: '25px' }}>Copia registro civil de matrimonio (interesado)</DialogTitle>
                <DialogContent>
                    <form >
                        <GridContainer >
                        ...
                        <GridContainer>
                            <GridItem xs={12} sm={12} md={8} >
                                <span style={{ fontSize: 14, color: '#aaaaaa' }}><b>Carta de autorización de los registrados *</b></span>
                                {cartaData()}
                            </GridItem>
                            <GridItem xs={12} sm={12} md={1} >
                                <div style={{ marginTop: "0px" }}>
