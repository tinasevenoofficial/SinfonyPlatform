...
export default function CopiaRegisNaciMenorInteresado() {
    ...
    const [cartaAuto, setCartaAuto] = useState(null);
    ...
    const onCartaAutoChange = event => {
        // Update the state 
        setCartaAuto(event.target.files[0]);
    };
    ...
    const cartaData = () => {
        if (cartaAuto) {
            return (
                <div>
                    <p style={{ fontSize: 10, color: '#aaaaaa' }}>Nombre: {cartaAuto.name}</p>
                </div>
            );
        } else {
            return (
    ...
    const sendData = () => {
        if ((numeroDocu && numeroFolio && fechaNaci && apellidos && nombres) !== '' && (cedulaSolicitante && cartaAuto)) {
            ...
            formData.append('tipo_documento', 'registroNacimiento_MenorInteresado');
            ...
            formData.append('documento_2', cartaAuto, 'carta_autorizacion_padres');
    ...
    return (
        <div>
            ...
            <Dialog fullWidth="true" maxWidth="md" open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title" style={{ paddingTop: '25px' }}>Copia registro de nacimiento (menor de edad/interesado)</DialogTitle>
                <DialogContent>
                    <form >
                        <GridContainer >
                        ...
                        <GridContainer>
                            <GridItem xs={12} sm={12} md={8} >
                                <span style={{ fontSize: 14, color: '#aaaaaa' }}><b>Carta de autorización de los padres *</b></span>
                                {cartaData()}
                            </GridItem>
                            <GridItem xs={12} sm={12} md={1} >
                                <div style={{ marginTop: "0px" }}>
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            accept='application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document'
                                            style={{ display: "none" }}
                                            onChange={(e) => onCartaAutoChange(e)}
                                        />
                                    </Button>
                                </div>
                            </GridItem>
