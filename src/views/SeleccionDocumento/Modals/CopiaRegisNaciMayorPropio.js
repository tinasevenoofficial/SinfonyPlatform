...
export default function CopiaRegisNaciMayorPropio() {
    ...
    const sendData = () => {
        if ((numeroDocu && numeroFolio && fechaNaci && apellidos && nombres) !== '' && (cedulaSolicitante)) {
            ...
            formData.append('tipo_documento', 'registroNacimiento_MayorPropio');
    ...
    return (
        <div>
            ...
            <Dialog fullWidth="true" maxWidth="md" open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title" style={{ paddingTop: '25px' }}>Copia registro de nacimiento (mayor de edad/propio)</DialogTitle>
                <DialogContent>
                    <form >
                        <GridContainer >
