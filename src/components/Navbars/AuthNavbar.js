...
export default function AuthNavbar(props) {
  ...
  var list = (
    <List className={classes.list}>
      ...
      <ListItem className={classes.listItem}>
        <NavLink
          to="https://www.notariadecima.com/presentation"
      ...
      <ListItem className={classes.listItem}>
        ...
        >
          <Fingerprint
            style={{ color: "black" }} /* className={classes.listItemIcon} */
          />
          <ListItemText
      ...
      {/* <ListItem className={classes.listItem}>
        <NavLink
          ...
          to={"/auth/qr"}
          className={cx(classes.navLink, {
            [classes.navLinkActive]: activeRoute("/auth/qr")
          })}
        >
  ...
  return (
    <AppBar
      color="mi"
      position="fixed" /* className="appbar-color" */ /* className={classes.appBar + appBarClasses} */
    >
